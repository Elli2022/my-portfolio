      ...
      <div className="min-h-screen min-h-screen animated-gradient">
        ...
        <div className="home">
          ...
          <p>
            ...
            programmering. Som en livslång lärande har jag nyligen omskolat mig
            från en karriär inom Kriminalvården, där jag finslipade min förmåga
            att tänka kritiskt och hantera kritiska situationer, till att nu
            följa min passion inom webbutveckling.
          </p>
          <p>
            ...
            tekniska och affärsmässiga aspekter av projekt jag engagerar mig i.
          </p>
          <p>
